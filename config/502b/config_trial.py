...
# set up env
load_dotenv(find_dotenv('.env',raise_error_if_not_found=True, usecwd=True), verbose=True, override=True)
...
SUBJECT_DIR = f"{os.environ.get('SUBJECT_DIR')}"
...
_meta_df = _meta_df[_meta_df['thisN'].notna()]  # -------- SET METADATA SELECTION --------
